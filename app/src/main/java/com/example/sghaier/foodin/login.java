...
public class login extends  AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnlogin.setTypeface(tf1);
        btnfcb.setTypeface(tf1);

        tv_subscrite.setTypeface(tf2);
        tv_ici.setTypeface(tf2);
        tv_forget_passwd.setTypeface(tf2);

        edit_login_email.setTypeface(tf2);password.setTypeface(tf2);


        btnfcb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(login.this, Restau.class);
                startActivity(i);
            }
        });
